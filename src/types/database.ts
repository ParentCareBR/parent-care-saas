    ...
    Tables: {
      ...
      cared_person_addresses: {
        Row: {
          ...
          receives_scheduled_visits: boolean | null;
      ...
      cared_person_important_information: {
        Row: {
          id: string;
          organization_id: string;
          cared_person_id: string;
